...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * 배열 항목 정렬
		 * - 기본 타입 또는 String 타입일 경우엔 자동으로 오름차순 정렬
		...
		// 배열 항목 검색 : 배열 항목에서 특정 값이 위치한 익덱스를 얻는것
		// 검색전 배열을 정렬후 검색
		...
		Arrays.sort(names1);
		index = Arrays.binarySearch(names1, "김민수");
		System.out.println("찾은 인덱스 : "+ index);
		
		Member m4 = new Member("홍길동");
		Member m5 = new Member("박동수");
		Member m6 = new Member("김민수");
